...
public:
	...
	cv::Mat getTargetModel() const 
	{ 
		return targetModel; 
	}

	void setTargetModel(cv::Mat val) { 
		targetModel = val; 
	}

	cv::Mat getInitialFrame() const 
	{ 
		return initialFrame; 
	}

	void setInitialFrame(cv::Mat val) 
	{ 
		initialFrame = val; 
	}
	...
	void setCurrentFrame(cv::Mat val) 
	{ 
		currentFrame = val; 
	}

	cv::Rect getTarget_initial() const 
	{ 
		return target_initial; 
	}

	void setTarget_initial(cv::Rect val) 
	{ 
		target_initial = val; 
	}

	cv::Rect getTarget_current() const 
	{ 
		return target_current; 
	}
	void setTarget_current(cv::Rect val) 
	{ 
		target_current = val; 
	}

	int getMaxIterNum() const 
	{ 
		return Nmax; 
	}
	void setMaxIterNum(int val) 
	{ 
		Nmax = val; 
	}

	cv::Mat getHistWeights() const 
	{ 
		return histWeights; 
	}
	void setHistWeights(cv::Mat val) 
	{ 
		histWeights = val; 
	}
